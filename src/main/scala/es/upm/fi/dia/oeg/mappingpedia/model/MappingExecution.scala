...
class MappingExecution(
                        ...
                        , val unannotatedDistributionsDownloadUrls:List[String]
                        , val ckanResourcesIds:List[String]
                        , val mdId:String
                        , val mdDownloadURL:String
                        , val mdHash:String
                      , val mapDistributionDownloadUrls:Map[String, String]
                      , val mapCkanResourceIds:Map[String, String]
